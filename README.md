...
# Usage
* To use, open the main 'spamBot.py' file and input the file path of a text file (your own or one of the included).
* The program will then give you a 5 second window to switch to the application you wish to run it in.
* To stop the spam move mouse to the top right or left screen corners, this initiates the pyautogui failsafe and
stops the program.
