...
def main():
    ...
    #note: you will need to copy the file path of the file to use it 
    print("Running...")
    ...
    for word in f:
        ...
        time.sleep(1.25)     #<-- used to bypass discord slowmode (for the most part) though can be changed as needed
